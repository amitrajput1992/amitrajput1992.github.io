...
import { W as WebGL1Renderer, a as WebGLRenderer, L as Layers, C as Color, T as Texture, s as sRGBEncoding, b as THREE, V as Vector2, R as Raycaster, S as Scene, O as OrthographicCamera, P as PerspectiveCamera, c as Clock, d as Vector3, e as PCFSoftShadowMap, A as ACESFilmicToneMapping } from './common/three.module-91782a50.js';
...
import { s as scheduler } from './common/index-c5935d46.js';
...
function useAsset(fn, ...args) {
  return react.useMemo(() => handleAsset(fn, globalCache, args, useAsset.lifespan), args);
}
...
const useCanvas = props => {
  ...
  const intersect = react.useCallback(filter => {
...
export { Canvas, extend, useFrame, useLoader, useThree };
